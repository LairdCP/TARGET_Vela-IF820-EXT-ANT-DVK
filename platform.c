...
void init_cycfg_all()
{
    ...
    //RF table for Vela-IF820-EXT-ANT
    ...
    btrf_pwrRamAdLEVs_br[0] = btrf_pwrRamAdLEVs_le[0] = 0x04;
    btrf_pwrRamAdLEVs_br[1] = btrf_pwrRamAdLEVs_le[1] = 0x08;
    btrf_pwrRamAdLEVs_br[2] = btrf_pwrRamAdLEVs_le[2] = 0x0D;
    btrf_pwrRamAdLEVs_br[3] = btrf_pwrRamAdLEVs_le[3] = 0x13;
    btrf_pwrRamAdLEVs_br[4] = btrf_pwrRamAdLEVs_le[4] = 0x17;
    btrf_pwrRamAdLEVs_br[5] = btrf_pwrRamAdLEVs_le[5] = 0x1B;
    *((uint32_t*)0x60019c) = 0x04;
}
